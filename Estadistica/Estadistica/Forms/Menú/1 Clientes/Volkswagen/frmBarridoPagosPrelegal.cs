...
{
    public partial class frmBarridoPagosPrelegal : Form
    {
        public frmBarridoPagosPrelegal()
        {
            InitializeComponent();
        ...
        public void Proceso()
        {
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Volkswagen.[2.4.Barrido_Pagos] ");
