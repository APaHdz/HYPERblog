...
{
    public partial class frmReporteConciliacion : Form
    {
        public frmReporteConciliacion()
        {
            InitializeComponent();
        ...
        public void Consulta()
        {
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Volkswagen.[1.3.1.VW_Saldo_Dia] @Agencia, @Inicial, @Final ");
            ...
            if (!DataBaseConn.Fill(tblSaldoDia, "1.3.1.VW_Saldo_Dia"))
            {
                TerminaBúsqueda("Falló proceso 1.3.1.VW_Saldo_Dia.", true);
                return;
            }
            ...
            for (int i = 0; i < tblSaldoDia.Rows.Count; i++)
            {
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; \r\n" +
                  "ALTER TABLE  dbEstadistica.Temp.VW_Saldo_Dia \r\n\t" +
                  "DROP COLUMN " + Columna);                
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; SELECT * FROM dbEstadistica.Temp.VW_Saldo_Dia");

            if (!DataBaseConn.Fill(tblConsulta,"C_VW_Saldo_Dia."))
            {                
            ...
            for (int i = 1; i < tblConsulta.Columns.Count; i++)
            {
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; \r\n" +
                  "USE dbEstadistica; EXEC sp_rename 'Temp.VW_Saldo_Dia." + NombreColumna + "','" + (i).ToString() + "'" );
            ...
            for (int i = tblConsulta.Columns.Count; i < 33; i++)
            {
                string NombreColumna = "[" + i.ToString() + "]";
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; \r\n" +
                  "USE dbEstadistica; ALTER TABLE [Temp].[VW_Saldo_Dia] ADD " + NombreColumna + " decimal(3,2) DEFAULT 0.00 NOT NULL ");
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Volkswagen.[1.3.Consolidado_LeasingDia] @Agencia, @Inicial, @Final ");
            DataBaseConn.CommandParameters.AddWithValue("@Agencia", sAgencia);
            DataBaseConn.CommandParameters.AddWithValue("@Inicial", Inicial);
            DataBaseConn.CommandParameters.AddWithValue("@Final", Final);
