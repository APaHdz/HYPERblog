...
{
    public partial class frmSegurosLeasing : Form
    {
        public frmSegurosLeasing()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                string[] Layout;
                Layout = new string[] { "C", "Fecha Solicitud", "Cliente", "Contrato", "Fecha de cargo del DC", "Importe", "Monto del financiamiento", "Ejecutivo", "Enviado" };
        ...
        public void CargaSegurosLeasing(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'SegL_" + Ejecutivo.Datos["idEjecutivo"] + "'  AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.SegL_" + Ejecutivo.Datos["idEjecutivo"]);

            if (!DataBaseConn.Execute("DropTemporalSegL")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.SegL_" + Ejecutivo.Datos["idEjecutivo"] + " ( ";
            for (int i = 0; i < tblSegurosLeasing.Columns.Count; i++)
            {
                if (tblSegurosLeasing.Columns[i].ColumnName == "Fecha Solicitud" || tblSegurosLeasing.Columns[i].ColumnName == "Fecha de cargo del DC")
            ...
            if (!DataBaseConn.Fill(CreaTemporalPag, "CreaTemporalSegL")){
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.SegL_" + Ejecutivo.Datos["idEjecutivo"];
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.[Volkswagen].[1.5.Seguros_Leasing] @idEjecutivo, @Fecha");
