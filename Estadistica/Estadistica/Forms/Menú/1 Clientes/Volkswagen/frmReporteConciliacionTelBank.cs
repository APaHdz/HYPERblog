...
{
    public partial class frmReporteConciliacionTelBank : Form
    {
        public frmReporteConciliacionTelBank()
        {
            InitializeComponent();
        ...
        public void Consulta()
        {
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Volkswagen.[3.3.1.VW_Saldo_Dia] @Agencia, @Inicial, @Final ");
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Volkswagen.[3.3.Consolidado_TelBankDia] @Agencia, @Inicial, @Final ");
            DataBaseConn.CommandParameters.AddWithValue("@Agencia", sAgencia);
            DataBaseConn.CommandParameters.AddWithValue("@Inicial", Inicial);
            DataBaseConn.CommandParameters.AddWithValue("@Final", Final);
