...
{
    public partial class frmValidacionDomicilios : Form
    {
        public frmValidacionDomicilios()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                string[] Layout;
                Layout = new string[] { "CRED_SII", "NOMBRE", "LINEA", "CUENTA", "Expediente", "Saldo", "SituaciónCuenta", "Nivel", "SALDO A LIQUIDAR", "Calle_Santo", "numInt_Santo", "numExt_Santo", "Col_Santo", "CP_Santo", "Deleg_Santo", "Ciudad", "EntidadFed_Santo", "UNO_Domicilio", "SICOBRA_Calle", "SICOBRA_numInt", "SICOBRA_numExt", "SICOBRA_Colonia", "SICOBRA_CP", "SICOBRA_Cda_Edo", "SICOBRA_Munici" };
        ...
        {            
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'DomiInbursa'  AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.DomiInbursa");

            if (!DataBaseConn.Execute("DropTemporalDomi")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.DomiInbursa ( ";
            ...
            if (!DataBaseConn.Fill(CreaTemporalAsi, "CreaTemporalDomi")){
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.DomiInbursa";
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.[Inbursa].[1.0.0.ValidaDomicilio]");                
