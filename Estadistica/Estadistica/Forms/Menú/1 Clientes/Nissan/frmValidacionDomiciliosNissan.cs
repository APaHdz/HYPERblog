...
{
    public partial class frmValidacionDomiciliosNissan : Form
    {
        public frmValidacionDomiciliosNissan()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                string[] Layout;
                Layout = new string[] { "CONTRATO", "DOM EMPRESA" };
        ...
        {            
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'DomiNissan'  AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.DomiNissan");
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.DomiNissan ( ";
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.DomiNissan";
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.[Nissan].[1.0.0.ValidaDomicilio]");                
