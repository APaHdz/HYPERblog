...
{
    public partial class frmNegociaciones : Form
    {
        public frmNegociaciones()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                string[] Layout;                
                Layout = new string[] { "FECHADERECEPCION", "CUENTAS", "SALDONEGOCIADO", "TIPODECONVENIO", "FECHADEVENCIMIENTO", "IMPORTEPAGOINICIAL", "NUMDEPAGOS", "IDPROGRAMA" };
            ...
            Invoke((Action)delegate(){
                dgvNegociaciones.DataSource = tblNegociaciones;                
        ...
        public void CargaNegociaciones(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'CiNe' AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.CiNe");

            if (!DataBaseConn.Execute("DropTemporalNegociaciones")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.CiNe ( ";
            for (int i = 0; i < tblNegociaciones.Columns.Count; i++){
            ...
            if (!DataBaseConn.Fill(CreaTemporalPag, "CreaTemporalNegociaciones")){
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.CiNe";
                ...
                string Fecha = dtpNegociaciones.Value.ToString("yyyy-MM-dd");

                Mensaje("Insertando remesa, por favor espere...", Color.DimGray, lblMensajes);
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.CityBanamex.[2.2.Negociaciones] @idEjecutivo, @Fecha");
