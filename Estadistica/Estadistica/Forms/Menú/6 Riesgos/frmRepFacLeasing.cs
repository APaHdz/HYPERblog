...
{
    public partial class frmRepFacLeasing : Form
    {
        public frmRepFacLeasing()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                Layout = new string[] { "Facturado a", "Número de Contrato",  "Monto de factura Sin IVA", "Monto de factura Con IVA", "Folio FUE Factura", "Fecha de apertura",  "Número del caso"};
        ...
        public void CargaPagos(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'REPFACLEAS' AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.REPFACLEAS");

            if (!DataBaseConn.Execute("DropTemporalREPFACLEAS")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.REPFACLEAS ( ";
            ...
            if (!DataBaseConn.Fill(CreaTemporalPag, "CreaTemporalFacLeasing")){
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.REPFACLEAS";
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Riesgos.[ReporteFacLeasing] @idCartera, @idProducto, @idEjecutivo, @Fecha ");                                
                ...
                if (!DataBaseConn.Execute("InsertaReporteFacturaLeasing")){
                    Mensaje("Falló al insertar reporte.", Color.Red, lblMensajes);
                    lector.Close();
                    Invoke((Action)delegate() { btnArchivo.Visible = true; picWaitBulk.Visible = false; });
                    return;
                }

                Mensaje("El reporte de facturas se insertó en el sistema.", Color.DimGray, lblMensajes);                
        ...
        private void cmbCarteras_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbCarteras.Text != "")
            {
               ...
               // Producto = cmbProducto.Text;
                ...
                txtRuta.Text = "";
                LimpiaMensajes();
                Mensaje("Seleccione un archivo con el layout de Reporte de Facturas Leasing " + Producto + ".", Color.SlateGray, lblMensajes);
            }
            else
