...
{
    public partial class frmDirecFacLeas : Form
    {
        public frmDirecFacLeas()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                Layout = new string[] {"NUM CONC", "ESTATUS", "TIPO DE FACTURACIÓN", "BU", "MARCA",
                                       "RAZÓN SOCIAL", "GRUPO", "CIUDAD", "Estado",  "INICIO DE OPERACIONES",
                                       "CIERRE DE OPERACIONES _SIN DEUDA / LEGAL", "TIPO CIERRE",
                                       "Conc#que toma cartera",	"SEMÁFORO",	"ASESOR DE FINANCIAMIENTO " 
        ...
        public void CargaPagos(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'DIRFACLEAS' AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.DIRFACLEAS");

            if (!DataBaseConn.Execute("DropTemporalDirectorio")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.DIRFACLEAS ( ";
            ...
            if (!DataBaseConn.Fill(CreaTemporalPag, "CreaTemporalDir")){
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.DIRFACLEAS";
                ...
                Mensaje("Insertando directorio, por favor espere...", Color.DimGray, lblMensajes);
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Riesgos.[DirectorioFacLeasing] @idCartera,@idProducto, @idEjecutivo, @Fecha ");                                
                ...
                if (!DataBaseConn.Execute("InsertaDirectorio")){
                    Mensaje("Falló al insertar Directorio.", Color.Red, lblMensajes);
                    lector.Close();
                    Invoke((Action)delegate() { btnArchivo.Visible = true; picWaitBulk.Visible = false; });
                    return;
                }

                Mensaje("El directorio de leasing se insertó en el sistema.", Color.DimGray, lblMensajes);                
        ...
        private void cmbCarteras_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbCarteras.Text != "")
            {
               ...
               // Producto = cmbProducto.Text;
                ...
                txtRuta.Text = "";
                LimpiaMensajes();
                Mensaje("Seleccione un archivo con el layout de Directorio Leasing" + Producto + ".", Color.SlateGray, lblMensajes);
            }
            else
