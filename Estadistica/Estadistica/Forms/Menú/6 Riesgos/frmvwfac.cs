...
{
    public partial class frmvwfac : Form
    {
        public frmvwfac()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                Layout = new string[] {"Cliente", "Contrato", "NC      Abono",	"ND        Cargo",	"Dev",	"Recla",	"Concepto",
                    "Documento",	"Fecha de Documento/solicitud",	"IMPT.S/IVA",	"IMPT.C/IVA",	"Explicación del movimiento / Motivo de Devolución",
                    "Numero de orden",	"Impr",	"Neg",	"Clave" };
        ...
        public void CargaPagos(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'FACVW' AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.Retenciones");

            if (!DataBaseConn.Execute("DropTemporalFACVW")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.FACVW ( ";
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.FACVW";
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Riesgos.[FacturasVW] @idCartera, @idProducto, @idEjecutivo, @Fecha ");                                
