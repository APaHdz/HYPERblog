...
{
    public partial class frmTelecom : Form
    {
        public frmTelecom()
        {
            InitializeComponent();
    ...
    //    }
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                Layout = new string[] { "idCuenta",	"FechaPago", "MontoPago"};
        ...
        public void CargaPagos(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'TELECOM' AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.TELECOM");
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.TELECOM ( ";
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.TELECOM";
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Riesgos.[BaseTelecom] @idEjecutivo, @Fecha ");                                
                ...
                Mensaje("Los pagos telecom se insertarón en el sistema.", Color.DimGray, lblMensajes);                
