    ...
    public partial class frmScore : Form
    {
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                Layout = new string[] { "idCuenta", "Saldo", "Cartera", "Producto", "Segmento", "Fecha_Calif", "TipoAsignacion", "max_score", "Predicción", "index", "CALIF SCORE", "BY" };
        ...
        public void CargaPagos(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'Score1' AND schema_id=21 ) " +
                " DROP TABLE dbEstadistica.Temp.Score1" + Ejecutivo.Datos["idEjecutivo"]);

            if (!DataBaseConn.Execute("DropTemporalScore1")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.Score1 ( ";
            ...
            if (!DataBaseConn.Fill(CreaTemporalPag, "CreaTemporalScore")){
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.Score1";
                ...
                Mensaje("Insertando Scores, por favor espere...", Color.DimGray, lblMensajes);
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Riesgos.[Score1] @idCartera, @idEjecutivo, @idProducto, @Fecha ");                                
                ...
                if (!DataBaseConn.Execute("InsertaScore")){
                    Mensaje("Falló al insertar Scores.", Color.Red, lblMensajes);
                    lector.Close();
                    Invoke((Action)delegate() { btnArchivo.Visible = true; picWaitBulk.Visible = false; });
                    return;
                }

                Mensaje("La información sobre Scores se insertó en el sistema.", Color.DimGray, lblMensajes);                
