...
{
    public partial class frmPagosCJ : Form
    {
        public frmPagosCJ()
        {
            InitializeComponent();
        ...
        public void Archivo(object oFilePath)
        {
            ...
            try{
                ...
                Layout = new string[] { "Cuenta1", "Cuenta2", "FechaPago", "MontoPago", "Mora", "Segmento", "Codigo1", "Codigo2", "Codigo3", "Codigo4", "Codigo5", "Plaza", "Region", "Division", "Sucursal", "Numero1", "Numero2", "Status", "Saldo_Pago" };
        ...
        public void CargaPagos(object oDatos)
        {
            ...
            DataBaseConn.SetCommand("IF EXISTS (SELECT 1 FROM dbEstadistica.sys.tables WHERE name = 'Pago_" + Ejecutivo.Datos["idEjecutivo"] + "'  AND schema_id=6 ) " +
                " DROP TABLE dbEstadistica.Temp.Pago_" + Ejecutivo.Datos["idEjecutivo"]);

            if (!DataBaseConn.Execute("DropTemporalPago")){
            ...
            string sCreateTable = "CREATE TABLE dbEstadistica.Temp.Pago_" + Ejecutivo.Datos["idEjecutivo"] + " ( ";
            ...
            using (SqlBulkCopy blkData = DataBaseConn.bulkCopy){{
                    try{
                        ...
                        blkData.DestinationTableName = "dbEstadistica.Temp.Pago_" + Ejecutivo.Datos["idEjecutivo"];
                ...
                DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Estadistica.[1.1.Pagos] @idCartera, @idProducto, @idEjecutivo, @Fecha ");                                
                ...
                if (!DataBaseConn.Execute("InsertaPagos")){
                    Mensaje("Falló al insertar pagos.", Color.Red, lblMensajes);
                    lector.Close();
                    Invoke((Action)delegate() { btnArchivo.Visible = true; picWaitBulk.Visible = false; });
                    return;
                }
        ...
        private void cmbCarteras_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbCarteras.Text != "")
            {
                ...
                txtRuta.Text = "";
                LimpiaMensajes();
                Mensaje("Seleccione un archivo con el layout de pagos " + Producto + ".", Color.SlateGray, lblMensajes);
            }
            else
