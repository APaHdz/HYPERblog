...
namespace Estadistica
{
    public partial class frmGenero : Form
    {
        ...
        public void Consulta()
        {
            ...
            if (rbAmbiguo.Checked == true)
                Tipo = "Ambiguo";

            Mensaje("En proceso el resultado de la consulta, por favor espere...", Color.DimGray, lblMensajes);
            Mensaje("En proceso el resultado de la consulta, por favor espere...", Color.DimGray, lblMensajes);
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Estadistica.[1.3.Genero] @idCartera, @idProducto, @Inicio");
            ...
            DataBaseConn.CommandParameters.AddWithValue("@Inicio", Tipo);
