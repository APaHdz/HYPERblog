...
{
    public partial class frmTelefonosCarterasConContacto : Form
    {
        public frmTelefonosCarterasConContacto()
        {
            InitializeComponent();                        
            PreparaVentana();
        }
        ...
        public void Consulta()
        {
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Estadistica.[1.20.TelefonosContacto] @idCartera");
