...
{
    public partial class frmDetalleAsignacion : Form
    {
        public frmDetalleAsignacion()
        {
            InitializeComponent();            
        ...
        public void Consulta()
        {
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Estadistica.[1.7.DetalleAsignacion] @idCartera, @Fin ");
            ...
            if (!DataBaseConn.Fill(tblMovAsig, "DetalleAsignacion"))
            {
