...
{
    public partial class frmTelefonosAsignacion : Form
    {
        public frmTelefonosAsignacion()
        {
            InitializeComponent();            
        ...
        public void Consulta()
        {
            ...
            DataBaseConn.SetCommand("WAITFOR DELAY '00:00:00'; EXEC dbEstadistica.Estadistica.[1.8.TelefonosAsignacion] @idCartera, @Fin ");
            ...
            if (!DataBaseConn.Fill(tblTelAsig, "TelefonosAsignacion"))
            {
